...
const PRE_QUESTIONS = [
  {
    ...
    options: ['พ.ศ. 2532 (ค.ศ. 1989)', 'พ.ศ. 2513 (ค.ศ. 1970)', 'พ.ศ. 2523 (ค.ศ. 1980)', 'พ.ศ. 2486 (ค.ศ. 1943)'],
    correct_index: 3,
  },
  {
  ...
  {
    question_text: 'ข้อใดคือจุดเด่นหลักในการทำตลาดของเครื่องจักรกลหนักแบรนด์ XCMG ในประเทศไทยยุคปัจจุบัน?',
    options: ['เน้นจำหน่ายเฉพาะเครื่องจักรระบบน้ำมันดีเซลแบบดั้งเดิมเท่านั้น', 'การเป็นผู้นำด้านนวัตกรรมเครื่องจักรพลังงานไฟฟ้า (EV) และความคุ้มค่าด้านราคา', 'มีฐานการผลิตใหญ่อยู่ในทวีปยุโรปเพียงแห่งเดียว', 'เน้นเจาะกลุ่มเป้าหมายเฉพาะเครื่องจักรการเกษตรขนาดเล็ก'],
    correct_index: 1,
  },
  {
...
const POST_QUESTIONS = [
  {
    ...
    options: ['5,000-10,000 คน', '15,000-25,000 คน', '30,000-40,000 คน', '100,000 คน'],
    correct_index: 2,
  },
  {
